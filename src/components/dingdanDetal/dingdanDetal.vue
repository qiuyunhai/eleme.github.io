<template>
	<div class="page-loadmore">
		<div class="page-loadmore-wrapper" :style="{height: wrapperHeight + 'px'}">
			...
			<mt-loadmore :bottom-method="loadBottom" @bottom-status-change="handleBottomChange" :bottom-all-loaded="allLoaded" ref="loadmore" :auto-fill="false">
...
<script>
	export default {
		...
		mounted() {
			...
			this.wrapperHeight = document.documentElement.clientHeight - 96;
		},
		methods: {
